 ...
 * Clock/Profiler are implemented in Rust, see ../../rust/). Must live in package `rpcimpls` as
 * `object AppServiceImplementations` — that fixed, well-known location is what lets the generated
